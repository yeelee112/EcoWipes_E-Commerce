...
<head>
    <meta charset="utf-8">
    <title>Chính sách bảo mật | Thế Giới Khăn Ướt</title>
                            ...
                            <div class="col-lg-12">
                                <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                                    ...
                                    <div class="single-content mb-50">
                                        ...
                                        <ul>
                                            <li class="unstyle-list">Dữ liệu cá nhân của Khách hàng sẽ được lưu trữ cho đến khi có yêu cầu hủy bỏ từ Khách hàng. Còn lại trong mọi trường hợp thông tin cá nhân Khách hàng sẽ được bảo mật trên máy chủ của EcoWipes.</li>
                                        </ul>
                                        ...
                                        <ul>
                                            <li>Khách hàng có quyền tự kiểm tra, cập nhật, điều chỉnh thông tin cá nhân của mình bằng cách đăng nhập vào tài khoản và chỉnh sửa thông tin cá nhân hoặc yêu cầu EcoWipes thực hiện việc này.</li>
                                            <li>Khách hàng có quyền gửi khiếu nại về việc lộ thông tin cá nhân cho bên thứ ba đến Ban quản trị của website <a href="https://thegioikhanuot.com/">thegioikhanuot.com</a>. Khi tiếp nhận những phản hồi này, EcoWipes sẽ xác nhận lại thông tin, phải có trách nhiệm trả lời lý do và hướng dẫn Khách hàng khôi phục và bảo mật lại thông tin.</li>
                                        </ul>
